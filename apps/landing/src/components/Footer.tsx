				...
				<div className="border-t border-gray-200 mt-8 pt-8 space-y-4">
					...
					<div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-xs text-amber-900">
						...
						<p className="mb-2">
							...
							Equity and Nondiscrimination for Investors Using Security Tokens).
							All tokenized securities offered on this platform are subject to
							federal securities laws and regulations.
						</p>
						<p className="mb-2">
							<strong>Investment Risks:</strong> Real estate investments involve
							substantial risk. Past performance does not guarantee future
							results. Investors may lose all or a portion of their investment.
							All investments are subject to market, regulatory, and liquidity
							risks.
						</p>
						<p>
