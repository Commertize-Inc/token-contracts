...
const getImageStyles = (memberName: string) => {
	const styles: {
		[key: string]: { objectPosition: string; transform?: string };
	} = {
...
const hasWhiteCircleInImage = (memberName: string) => {
	return ["Hector Garcia", "Daniel Soufer", "Ethan Shokrian"].includes(
		memberName
	);
};
...
export default function Team() {
	return (
		<div className="min-h-screen relative">
			<SEO
				title="Our Team"
				description="Meet the visionary team behind Commertize - innovators, deal-makers, and technologists revolutionizing commercial real estate through blockchain tokenization."
			/>
			...
			<div className="relative z-10 pt-20">
				...
				<section className="relative py-24 px-4 overflow-hidden">
					...
					>
						...
						>
							We&apos;re a team of innovators, deal-makers, and technologists
							with one mission: to make commercial real estate investment
							faster, more transparent, and accessible to more people through
				...
				>
					<div className="container mx-auto max-w-4xl text-center relative z-10">
						...
						>
							Be part of the future of real estate investment with our
