...
const defiProducts = [
	{
		...
		title: "CRE Staking",
		description:
			"Stake your tokenized real estate assets to earn passive yield from rental income and appreciation.",
		icon: PiggyBank,
	...
	},
	{
		...
		description:
			"Borrow against your tokenized property holdings with competitive rates and flexible terms.",
		icon: DollarSign,
	...
	},
	{
		...
		title: "Yield Farming",
		description:
			"Provide liquidity to CRE-USDC pools and earn enhanced yields plus CTZ governance tokens.",
		icon: Zap,
	...
	},
	{
		...
		title: "Smart Vaults",
		description:
			"Automated yield optimization strategies across multiple property pools for maximum returns.",
		icon: Target,
...
const securityFeatures = [
	...
	},
	{
		...
		description:
			"Protocol funds secured by multi-signature wallet with timelocked transactions.",
		icon: Lock,
	},
	{
		title: "Real Estate Collateral",
		description:
			"Every token backed by verified commercial real estate assets with clear title.",
		icon: Building2,
	},
	{
		title: "Insurance Coverage",
		description:
			"Smart contract coverage and property insurance through trusted carriers.",
		icon: CheckCircle,
	},
];
...
const howItWorks = [
	{
		...
		desc: "Link your Web3 wallet to access Nexus",
	},
	{
		step: "2",
		title: "Deposit Assets",
		desc: "Stake property tokens or stablecoins",
	},
	{
		step: "3",
		title: "Earn Yield",
		desc: "Receive rewards from protocol fees",
	},
	{
		step: "4",
		title: "Withdraw Anytime",
		desc: "Access your funds when you need them",
	},
];
...
const SectionTitle = ({
	...
	<div className="text-center mb-12">
		...
		<h2
			className={`text-3xl md:text-4xl font-light ${light ? "text-white" : "text-gray-900"}`}
			style={{ fontFamily: "sans-serif" }} // Simplified font family
		>
			{title}
		</h2>
	</div>
...
export default function Nexus() {
	return (
		<>
			<SEO
				title="Nexus DeFi Protocol - Liquidity for Real Estate"
				description="Commertize Nexus: The liquidity engine for tokenized real estate. Stake, lend, and borrow against your property assets."
				keywords={[
					"DeFi",
			...
			<div className="relative min-h-screen">
				...
				{/* ==================== HERO SECTION ==================== */}
				<section className="relative min-h-screen flex flex-col justify-center py-24 md:py-32 overflow-hidden z-10">
					...
					<div className="container mx-auto px-4 relative z-10">
						...
						>
							<PageHeader
								...
								subtitle="Stake, lend, borrow, and earn yield on tokenized commercial real estate assets."
								className="py-0"
							/>
							<div className="mt-8">
				...
				{/* ==================== APY SECTION ==================== */}
				<section className="relative min-h-screen flex flex-col justify-center py-16 z-10">
				...
				<section
					id="about"
					className="relative min-h-screen flex flex-col justify-center py-16 z-10"
				>
						...
						<div className="max-w-3xl mx-auto">
							...
							<div className="bg-white/90 backdrop-blur-md rounded-2xl p-8 border border-gray-200 shadow-lg">
								<p className="text-gray-700 text-lg leading-relaxed text-center">
									Nexus is Commertize&apos;s decentralized finance protocol — a
									liquidity engine enabling investors to borrow, lend, and earn
									yield from tokenized commercial real estate assets. Built on
									Ethereum, Nexus bridges traditional property value with DeFi
									lending pools, providing instant liquidity without selling
									your assets.
								</p>
							</div>
					...
					<div className="container mx-auto px-4 relative z-10">
						<div className="max-w-4xl mx-auto">
							...
							<p className="text-center text-gray-600 max-w-2xl mx-auto mb-10">
								...
								including audited smart contracts and collateralization ratios.
							</p>
							<div className="grid md:grid-cols-2 gap-6">
