									...
									<div className="prose prose-gray max-w-none">
										...
										<div className="pl-6">
											...
											<div className="space-y-4 mb-8">
												...
												<div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
													...
													<p className="text-gray-600 font-light text-sm">
														IP address, browser, device type, OS, referring
														pages, time/date stamps.
													</p>
												</div>
												<div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
													<p className="text-gray-800 mb-1">
										...
										<div className="pl-6">
											...
											<ul className="space-y-2 mb-8">
												...
												<li className="flex gap-3 text-gray-600 font-light">
													<div className="w-2 h-2 rounded-full bg-[#D4A024] mt-2 flex-shrink-0"></div>
													Regulatory bodies or law enforcement agencies to
										...
										<div className="pl-6">
											<p className="text-gray-600 font-light mb-8">
												...
												no internet transmission is fully secure; thus, we
										...
										<div className="pl-6">
											<p className="text-gray-600 font-light mb-8">
												...
												collected, or as required by law or regulation,
										...
										<div className="pl-6">
											<p className="text-gray-600 font-light mb-8">
												...
												such collection, we will promptly delete the
												information.
											</p>
										</div>
