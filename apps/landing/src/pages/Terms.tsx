								...
								<div className="prose prose-gray max-w-none">
									...
									<div className="pl-6">
										<p className="text-gray-600 font-light mb-4">
											...
											agree that you have read, understood, and agree to be
										...
										<div className="space-y-4 mb-8">
											<div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
												...
												<p className="text-gray-600 font-light text-sm">
													You must be at least 18 years old (or the applicable
													age of majority in your jurisdiction) to use our
													Service.
												</p>
											</div>
											<div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
										...
										<div className="space-y-4 mb-8">
											...
											<div className="flex gap-3">
												...
												<p className="text-gray-600 font-light">
													...
													Commertize immediately at support@commertize.com.
												</p>
											</div>
											<div className="flex gap-3">
												<div className="w-2 h-2 rounded-full bg-[#D4A024] mt-2 flex-shrink-0"></div>
									...
									<div className="pl-6">
										<p className="text-gray-600 font-light mb-8">
											...
											information from users as needed to provide the Service
										...
										<div className="space-y-4 mb-8">
											...
											<div className="flex gap-3">
												...
												<p className="text-gray-600 font-light">
													...
													explicit prior written permission from Commertize.
												</p>
											</div>
										</div>
									</div>
										...
										<div className="space-y-4 mb-8">
											<div className="flex gap-3">
												...
												<p className="text-gray-600 font-light">
													...
													Certain features of the Service may enable you to
											...
											<div className="flex gap-3">
												...
												<p className="text-gray-600 font-light">
													...
													party). Any personal or transactional information
													shared with a broker-dealer is subject to the
													broker-dealer&apos;s own privacy and data handling
													policies.
												</p>
											</div>
											<div className="flex gap-3">
										...
										<div className="space-y-4 mb-8">
											<div className="flex gap-3">
												...
												<p className="text-gray-600 font-light">
													...
													technological safeguards to protect your data.
													However, no system is completely secure, and
													Commertize cannot guarantee the absolute security of
													its systems.
												</p>
											</div>
											<div className="flex gap-3">
										...
										<div className="space-y-4 mb-8">
											<div className="flex gap-3">
												...
												<p className="text-gray-600 font-light">
													...
													These Terms, along with any other agreements or
													policies referenced herein, constitute the entire
													agreement between you and Commertize regarding your
													use of the Service.
												</p>
											</div>
											<div className="flex gap-3">
