						...
						<div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-[#D4A024]/30 p-8 md:p-12">
							<div className="prose prose-gray max-w-none">
								<p className="text-gray-600 font-light leading-relaxed mb-8">
									This Cookie Policy explains how Commertize, Inc.
									(&quot;Commertize,&quot; &quot;we,&quot; &quot;us,&quot; or
									&quot;our&quot;) uses cookies and similar tracking
									technologies when you visit our website at www.commertize.com
									(the &quot;Website&quot;). By using our Website, you consent
								...
								<p className="text-gray-600 font-light mb-8">
									...
									provide a better user experience, and give website owners
								...
								<div className="space-y-4 mb-8">
									<div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
										...
										<p className="text-gray-600 font-light text-sm">
											...
											of these cookies as they are necessary for the Website to
											operate.
										</p>
									</div>
									<div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
									...
									<div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
										...
										<p className="text-gray-600 font-light text-sm">
											...
											language settings, and login information.
										</p>
									</div>
									<div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
										<p className="text-gray-800 mb-1">
										...
										<p className="text-gray-600 font-light text-sm">
											...
											the effectiveness of advertising campaigns and limit the
								...
								<p className="text-gray-600 font-light mb-4">
									...
									advertisements, and provide other services. These third
									parties include:
								</p>
								<ul className="space-y-2 mb-8">
									...
									<li className="flex gap-3 text-gray-600 font-light">
										<div className="w-2 h-2 rounded-full bg-[#D4A024] mt-2 flex-shrink-0"></div>
										Social media platforms (when you interact with our social
										features)
									</li>
								</ul>
								...
								<div className="space-y-4 mb-8">
									<div className="flex gap-3">
										...
										<p className="text-gray-600 font-light">
											<span className="text-gray-800">Session Cookies:</span>{" "}
											These are temporary cookies that are deleted when you
											close your browser. They are used to maintain your session
									...
									<div className="flex gap-3">
										<div className="w-2 h-2 rounded-full bg-[#D4A024] mt-2 flex-shrink-0"></div>
										<p className="text-gray-600 font-light">
											<span className="text-gray-800">Persistent Cookies:</span>{" "}
											These cookies remain on your device for a set period or
											until you delete them. They are used to remember your
											preferences and choices across multiple visits.
										</p>
									</div>
								</div>
								...
								<ul className="space-y-2 mb-8">
									<li className="flex gap-3 text-gray-600 font-light">
										<div className="w-2 h-2 rounded-full bg-[#D4A024] mt-2 flex-shrink-0"></div>
										<span>
											<span className="text-gray-800">Browser Settings:</span>{" "}
											Most web browsers allow you to control cookies through
											their settings. You can set your browser to refuse
											cookies, delete cookies, or alert you when a cookie is
											being set.
										</span>
									</li>
									<li className="flex gap-3 text-gray-600 font-light">
										<div className="w-2 h-2 rounded-full bg-[#D4A024] mt-2 flex-shrink-0"></div>
										<span>
											<span className="text-gray-800">Opt-Out Tools:</span> Some
											third-party services provide opt-out mechanisms. For
									...
									<li className="flex gap-3 text-gray-600 font-light">
										<div className="w-2 h-2 rounded-full bg-[#D4A024] mt-2 flex-shrink-0"></div>
										<span>
											<span className="text-gray-800">Do Not Track:</span> Some
											browsers offer a &quot;Do Not Track&quot; feature. Our
											Website currently does not respond to &quot;Do Not
											Track&quot; signals.
										</span>
									</li>
								</ul>
								<p className="text-gray-600 font-light mb-8">
									...
									functionality of our Website and limit your ability to use
									certain features.
								</p>
								...
								<div className="space-y-4 mb-8">
									<div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
										...
										<p className="text-gray-600 font-light text-sm">
											...
											help us understand how users interact with our content.
										</p>
									</div>
									<div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
										<p className="text-gray-800 mb-1">Local Storage</p>
										<p className="text-gray-600 font-light text-sm">
											Browser-based storage that allows us to store data locally
											on your device for improved performance.
										</p>
									</div>
									<div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
										<p className="text-gray-800 mb-1">Session Storage</p>
										<p className="text-gray-600 font-light text-sm">
											Similar to local storage but is cleared when you close
								...
								<p className="text-gray-600 font-light mb-8">
									...
									by posting the updated policy on our Website with a new
