			...
			<div className="relative z-10 pt-20">
				...
				<section className="relative py-24 px-4 overflow-hidden">
					...
					>
						...
						>
							We're a team of innovators, deal-makers, and technologists with
							one mission: to make commercial real estate investment faster,
							more transparent, and accessible to more people through blockchain
							tokenization.
						</motion.p>
					</motion.div>
				</section>
