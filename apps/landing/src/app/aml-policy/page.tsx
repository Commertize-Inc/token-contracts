						...
						<div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-[#D4A024]/30 p-8 md:p-12">
							<div className="prose prose-gray max-w-none">
								<p className="text-gray-600 font-light leading-relaxed mb-8">
									...
									(AML) and Counter-Terrorism Financing (CTF) compliance. This
									AML Policy outlines our commitment to preventing the use of
									our platform for money laundering, terrorist financing, or
								...
								<ul className="space-y-2 mb-8">
									<li className="flex gap-3 text-gray-600 font-light">
										<div className="w-2 h-2 rounded-full bg-[#D4A024] mt-2 flex-shrink-0"></div>
										Screening all customers against OFAC's Specially Designated
										Nationals (SDN) List
									</li>
									<li className="flex gap-3 text-gray-600 font-light">
										<div className="w-2 h-2 rounded-full bg-[#D4A024] mt-2 flex-shrink-0"></div>
