      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-light text-gray-900 mb-4">AML Policy</h1>
            <p className="text-gray-500 font-light">Anti-Money Laundering Compliance</p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-[#D4A024]/30 p-8 md:p-12">
              <div className="prose prose-gray max-w-none">
                ...
                <h2 className="text-2xl text-[#D4A024] mt-10 mb-6">1. Policy Statement</h2>
                ...
                <h2 className="text-2xl text-[#D4A024] mt-10 mb-6">2. Regulatory Framework</h2>
                <p className="text-gray-600 font-light mb-4">Our AML program is designed to comply with:</p>
                ...
                <h2 className="text-2xl text-[#D4A024] mt-10 mb-6">3. AML Program Components</h2>
                <p className="text-gray-600 font-light mb-4">Our AML compliance program includes the following key components:</p>
                
                <div className="space-y-4 mb-8">
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    <p className="text-gray-800 mb-1">Designation of AML Compliance Officer</p>
                    <p className="text-gray-600 font-light text-sm">A qualified individual responsible for overseeing the AML program, ensuring compliance, and serving as the primary point of contact for regulatory inquiries.</p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    <p className="text-gray-800 mb-1">Written Policies and Procedures</p>
                    <p className="text-gray-600 font-light text-sm">Comprehensive internal policies and procedures designed to detect and prevent money laundering and terrorist financing activities.</p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    <p className="text-gray-800 mb-1">Customer Due Diligence (CDD)</p>
                    <p className="text-gray-600 font-light text-sm">Risk-based procedures for verifying customer identity, understanding the nature of customer relationships, and conducting ongoing monitoring.</p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    <p className="text-gray-800 mb-1">Employee Training</p>
                    <p className="text-gray-600 font-light text-sm">Regular training programs for all employees on AML requirements, red flags, and reporting obligations.</p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    <p className="text-gray-800 mb-1">Independent Audit</p>
                    <p className="text-gray-600 font-light text-sm">Periodic independent testing of our AML program to ensure its effectiveness and identify areas for improvement.</p>
                  </div>
                </div>

                <h2 className="text-2xl text-[#D4A024] mt-10 mb-6">4. Customer Identification Program (CIP)</h2>
                ...
                <h2 className="text-2xl text-[#D4A024] mt-10 mb-6">5. Enhanced Due Diligence (EDD)</h2>
                <p className="text-gray-600 font-light mb-4">
                ...
                <h2 className="text-2xl text-[#D4A024] mt-10 mb-6">6. Transaction Monitoring</h2>
                <p className="text-gray-600 font-light mb-4">
                ...
                <div className="space-y-4 mb-8">
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    ...
                    <p className="text-gray-600 font-light text-sm">Real-time and batch monitoring systems that flag unusual transaction patterns, velocity, and amounts.</p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    <p className="text-gray-800 mb-1">Risk-Based Thresholds</p>
                    <p className="text-gray-600 font-light text-sm">Customized thresholds based on customer risk profiles and expected transaction behavior.</p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    <p className="text-gray-800 mb-1">Alert Investigation</p>
                    <p className="text-gray-600 font-light text-sm">Trained compliance staff review and investigate flagged transactions to determine if suspicious activity reporting is required.</p>
                  </div>
                </div>

                <h2 className="text-2xl text-[#D4A024] mt-10 mb-6">7. Suspicious Activity Reporting</h2>
                <p className="text-gray-600 font-light mb-8">
                ...
                <h2 className="text-2xl text-[#D4A024] mt-10 mb-6">8. Sanctions Compliance</h2>
                <p className="text-gray-600 font-light mb-4">
                ...
                <h2 className="text-2xl text-[#D4A024] mt-10 mb-6">9. Recordkeeping</h2>
                <p className="text-gray-600 font-light mb-8">
                ...
                <h2 className="text-2xl text-[#D4A024] mt-10 mb-6">10. Red Flags</h2>
                <p className="text-gray-600 font-light mb-4">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex gap-3">
                    <div className="w-2 h-2 rounded-full bg-[#D4A024] mt-2 flex-shrink-0"></div>
                    <p className="text-gray-600 font-light">Reluctance to provide complete identification information</p>
                  </div>
                  <div className="flex gap-3">
                    <div className="w-2 h-2 rounded-full bg-[#D4A024] mt-2 flex-shrink-0"></div>
                    <p className="text-gray-600 font-light">Providing false, misleading, or substantially incorrect information</p>
                  </div>
                  <div className="flex gap-3">
                    <div className="w-2 h-2 rounded-full bg-[#D4A024] mt-2 flex-shrink-0"></div>
                    <p className="text-gray-600 font-light">Unusual transaction patterns inconsistent with stated purpose</p>
                  </div>
                  <div className="flex gap-3">
                    <div className="w-2 h-2 rounded-full bg-[#D4A024] mt-2 flex-shrink-0"></div>
                    <p className="text-gray-600 font-light">Transactions with no apparent economic or lawful purpose</p>
                  </div>
                  <div className="flex gap-3">
                    <div className="w-2 h-2 rounded-full bg-[#D4A024] mt-2 flex-shrink-0"></div>
                    <p className="text-gray-600 font-light">Structuring transactions to avoid reporting thresholds</p>
                  </div>
                  <div className="flex gap-3">
                    <div className="w-2 h-2 rounded-full bg-[#D4A024] mt-2 flex-shrink-0"></div>
                    <p className="text-gray-600 font-light">Connections to high-risk jurisdictions or sanctioned countries</p>
                  </div>
                </div>

                <h2 className="text-2xl text-[#D4A024] mt-10 mb-6">11. Cooperation with Law Enforcement</h2>
                <p className="text-gray-600 font-light mb-8">
                ...
                <h2 className="text-2xl text-[#D4A024] mt-10 mb-6">12. Policy Updates</h2>
                <p className="text-gray-600 font-light mb-8">
                ...
                <h2 className="text-2xl text-[#D4A024] mt-10 mb-6">13. Contact Us</h2>
                <p className="text-gray-600 font-light mb-4">For questions about our AML program or to report suspicious activity, please contact us at:</p>
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-100">
                  <p className="text-gray-800">Commertize, Inc.</p>
                  <p className="text-gray-600 font-light">Attn: AML Compliance Officer</p>
