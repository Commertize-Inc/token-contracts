						...
						<div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-[#D4A024]/30 p-8 md:p-12">
							<div className="prose prose-gray max-w-none">
								<p className="text-gray-600 font-light leading-relaxed mb-8">
									...
									("Commertize," "we," "us," or "our") uses cookies and similar
									tracking technologies when you visit our website at
									www.commertize.com (the "Website"). By using our Website, you
								...
								<ul className="space-y-2 mb-8">
									...
									<li className="flex gap-3 text-gray-600 font-light">
										...
										<span>
											...
											browsers offer a "Do Not Track" feature. Our Website
