...
export default function Home() {
        ...
        return (
                <div style={{ minHeight: '100vh', fontFamily: 'var(--font-sans)', backgroundColor: '#FAFAF9', color: '#0f172a' }}>
                        ...
                        {/* Enhanced Footer */}
                        <footer className="bg-white relative z-20 border-t border-gray-100" id="contact">
                                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                                        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
                                                {/* Column 1: Logo & Social */}
                                                <div>
                                                        <Logo className="mb-4" theme="dark" />
                                                        ...
                                                        <div className="mb-6">
                                                                <h4 className="font-medium mb-3 text-sm text-gray-900">Social Links</h4>
                                                ...
                                                <div>
                                                        ...
                                                        <ul className="space-y-2 text-sm">
                                                                <li><a href="/marketplace" className="text-gray-600 hover:text-[#D4A024] transition-colors">Explore Marketplace</a></li>
                                                                <li><a href="/dashboard" className="text-gray-600 hover:text-[#D4A024] transition-colors">Submit Property</a></li>
                                                                <li><a href="#about" className="text-gray-600 hover:text-[#D4A024] transition-colors">About Us</a></li>
                                                                <li><a href="#contact" className="text-gray-600 hover:text-[#D4A024] transition-colors">Contact</a></li>
                                                                <li><a href="/waitlist" className="text-gray-600 hover:text-[#D4A024] transition-colors">Join Waitlist</a></li>
                                                        </ul>
                                                </div>

                                                {/* Column 3: Divisions */}
                                                <div>
                                                        <h4 className="font-medium mb-4 text-gray-900">Divisions</h4>
                                                        <ul className="space-y-2 text-sm">
                                                                <li><a href="/marketplace" className="text-gray-600 hover:text-[#D4A024] transition-colors">Marketplace</a></li>
                                                                <li><a href="/defi" className="text-gray-600 hover:text-[#D4A024] transition-colors">DeFi & Nexus</a></li>
                                                                <li><a href="/omnigrid" className="text-gray-600 hover:text-[#D4A024] transition-colors">OmniGrid</a></li>
                                                        </ul>
                                                </div>
                                                ...
                                                <div>
                                                        ...
                                                        <ul className="space-y-2 text-sm">
                                                                <li><a href="/privacy" className="text-gray-600 hover:text-[#D4A024] transition-colors">Privacy Policy</a></li>
                                                                <li><a href="/terms" className="text-gray-600 hover:text-[#D4A024] transition-colors">Terms of Service</a></li>
                                                                <li><a href="/disclaimer" className="text-gray-600 hover:text-[#D4A024] transition-colors">Disclaimer</a></li>
                                                                <li><a href="/aml-policy" className="text-gray-600 hover:text-[#D4A024] transition-colors">AML Policy</a></li>
                                                                <li><a href="/cookie-policy" className="text-gray-600 hover:text-[#D4A024] transition-colors">Cookie Policy</a></li>
                                                                <li><a href="/kyb-policy" className="text-gray-600 hover:text-[#D4A024] transition-colors">KYB Policy</a></li>
                                                        </ul>
                                                </div>
                                                ...
                                                <div>
                                                        ...
                                                        <form className="flex gap-2" id="subscribe">
                                                                <input
                                                                        ...
                                                                        className="flex-1 px-3 py-2 text-sm border border-gray-200 rounded-lg bg-gray-50 text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#D4A024]/50"
                                                                />
                                                                <button type="submit" className="px-4 py-2 bg-[#D4A024] text-white text-sm font-medium rounded-lg hover:bg-[#D4A024]/90 transition-colors">
                                                                        Subscribe
                                                                </button>
                                                        </form>
                                                </div>
                                        ...
                                        <div className="border-t border-gray-200 mt-8 pt-8 space-y-4">
                                                ...
                                                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-xs text-amber-900">
                                                        <p className="font-medium mb-2">Legal & Regulatory Compliance</p>
                                                        ...
                                                        <p className="mb-2 font-light">
                                                                <strong className="font-medium">Investment Risks:</strong> Real estate investments involve substantial risk. Past performance does not guarantee future results. 
                                                        ...
                                                        <p className="font-light">
                                                                <strong className="font-medium">Regulatory Status:</strong> Securities offered through this platform are conducted in accordance with applicable exemptions 
