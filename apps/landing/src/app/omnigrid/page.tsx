					...
					<div className="container mx-auto px-4 text-center max-w-4xl">
						...
						>
							...
							<p className="text-lg font-normal text-gray-800 max-w-3xl mx-auto leading-relaxed">
								Solar. Data Centers. Clean Energy. OmniGrid tokenizes the
								physical assets driving global innovation.
							</p>
						</motion.div>
					</div>
				</section>
				...
				<section className="py-24 relative z-10 bg-gray-50">
					<div className="container mx-auto px-4 max-w-7xl">
						...
						>
							...
							>
								Eight Pillars of{" "}
								<span className="text-[#D4A024]">Global Infrastructure</span>
							</h2>
							<p className="text-lg text-gray-600 max-w-3xl mx-auto mt-4">
								From earth's resources to digital networks — a comprehensive
