...
const faqData = [
	{
		...
		items: [
			...
			{
				q: "What types of properties does Commertize work with?",
				a: "We focus on premium and full-spectrum commercial real estate, including multifamily, office, retail, industrial, hospitality, and mixed-use properties.",
			},
		],
	},
	{
