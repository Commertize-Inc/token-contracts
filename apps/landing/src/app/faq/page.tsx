      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-light text-gray-900 mb-4">Frequently Asked Questions</h1>
              ...
              <div key={sectionIndex}>
                <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-[#D4A024]/30">
                  <div className="px-6 py-5 flex items-center gap-3">
                    ...
                    <h2 className="text-xl text-gray-900">{section.category}</h2>
                  </div>
                  <div className="border-t border-gray-100">
                    {section.items.map((item, itemIndex) => (
                      <details key={itemIndex} className="group border-b border-gray-100 last:border-b-0">
