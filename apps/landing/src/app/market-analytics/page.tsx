...
const upcomingFeatures = [
  { 
    ...
    description: "Track total market capitalization, trading volumes, and market trends in real-time."
  },
  { 
    icon: Building2,
    title: "Property Analytics",
    description: "Monitor tokenized properties, performance metrics, and asset class distributions."
  },
  { 
    icon: TrendingUp,
    title: "Performance Tracking",
    description: "View top performers, yield comparisons, and historical price movements."
  },
  { 
    icon: Globe,
    title: "Geographic Insights",
    description: "Explore property distributions across regions and emerging market opportunities."
  },
  { 
    icon: Activity,
    title: "Live Transactions",
    description: "Follow real-time trading activity with detailed transaction history."
  },
  { 
    icon: PieChart,
    title: "Portfolio Analytics",
    description: "Analyze your investment portfolio with comprehensive breakdowns and projections."
  },
];
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-[#D4A024] to-[#B8860B] mb-6">
              <BarChart3 className="w-8 h-8 text-white" />
            </div>
            <h1 className="text-4xl md:text-5xl font-light text-gray-900 mb-4">Market Analytics</h1>
            <p className="text-xl text-gray-500 mb-2">Real Estate Tokenization Intelligence</p>
            <p className="text-gray-600">
              Comprehensive analytics and insights into the tokenized real estate market. 
              Track performance, discover trends, and make informed investment decisions.
            </p>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-gray-600 mb-6">
                  We're building powerful analytics tools to help you navigate the tokenized real estate market. 
                  Join our waitlist to be notified when we launch and get early access to market insights.
                </p>
                <Link 
                  href="/waitlist"
          ...
          <div className="mb-16">
            <div className="text-center mb-10">
              <h3 className="text-2xl font-light text-gray-900 mb-2">What to Expect</h3>
              <p className="text-gray-500">Powerful tools to analyze the tokenized real estate market</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {[
              ...
              { icon: Building2, label: "Properties Tokenized" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-16">
            <div className="lg:col-span-2 bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <div className="h-64 flex items-end justify-between gap-2 px-4">
                {[80, 100, 60, 120, 90, 140, 110, 130, 70, 150, 95, 160].map((height, i) => (
          ...
          <div className="text-center bg-[#FDF8F3] rounded-2xl p-8 md:p-12">
            ...
            <h3 className="text-2xl font-light text-gray-900 mb-3">Be the First to Know</h3>
            <p className="text-gray-600 mb-6 max-w-lg mx-auto">
              Get notified when our analytics platform goes live and receive exclusive early access to market insights.
            </p>
            <Link 
              href="/waitlist"
      ...
      <footer className="bg-white border-t border-gray-100 py-8">
        <div className="container mx-auto px-4 text-center text-sm text-gray-500">
          <p>&copy; {new Date().getFullYear()} Commertize. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
