...
const upcomingFeatures = [
	...
	},
	{
		...
		description:
			"Monitor tokenized properties, performance metrics, and asset class distributions.",
	},
	{
		icon: TrendingUp,
						...
						<div className="flex flex-col md:flex-row items-center gap-8">
							<div className="flex-1 text-center md:text-left">
								...
								<p className="text-gray-600 mb-6">
									We're building powerful analytics tools to help you navigate
									the tokenized real estate market. Join our waitlist to be
									notified when we launch and get early access to market
									insights.
								</p>
								<Link
									href="/waitlist"
