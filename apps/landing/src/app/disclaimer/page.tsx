							...
							<div className="prose prose-gray max-w-none">
								<div className="bg-amber-50 rounded-xl p-6 border border-[#D4A024]/30 mb-10">
									<p className="text-gray-700 text-sm">
										...
										information or services provided by Commertize, Inc. This
										disclaimer governs your use of our website, platform, and
								...
								<p className="text-gray-600 font-light mb-8">
									...
									risks, including illiquidity, market volatility, and potential
									loss of principal. Investment values can fluctuate
									significantly, and investors may lose their entire investment.
								...
								<p className="text-gray-600 font-light mb-8">
									Commertize does not provide investment, legal, financial, or
									tax advice. All information on our platform is for
									informational purposes only. Users are solely responsible for
									conducting their own thorough due diligence and should consult
								...
								<p className="text-gray-600 font-light mb-8">
									...
									which may prove incorrect or imprecise. Actual outcomes may
								...
								<p className="text-gray-600 font-light mb-8">
									Commertize accepts no responsibility or liability concerning
									content, accuracy, or security of third-party websites,
									services, or information linked from our platform. Users
								...
								<p className="text-gray-600 font-light mb-8">
									...
									no guarantee that any investment will achieve its objectives,
									generate positive returns, or avoid losses. Any historical
									returns, expected returns, or probability projections are for
								...
								<p className="text-gray-600 font-light mb-8">
									Commertize reserves the right to modify this disclaimer at any
