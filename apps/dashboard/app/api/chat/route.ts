...
export async function POST(request: NextRequest) {
        try {
                ...
                const suggestedActions = generateSuggestedActions(message, assistantMessage);
...
function generateSuggestedActions(userMessage: string, assistantResponse: string): string[] {
        ...
        if (lowerResponse.includes('portfolio') || lowerResponse.includes('diversif')) {
