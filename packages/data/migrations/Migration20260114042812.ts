...
export class Migration20260114042812 extends Migration {
	...
	override async down(): Promise<void> {
		...
		this.addSql(
			`alter table "sponsor_update_request" add constraint "sponsor_update_request_sponsor_id_foreign" foreign key ("sponsor_id") references "sponsor" ("id") on update cascade;`
		);

		this.addSql(`alter table "notification" drop column "metadata";`);
	}
}
