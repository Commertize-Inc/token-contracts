...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
    ...
    export type MessagingParamsStruct = {dstEid: BigNumberish, receiver: BytesLike, message: BytesLike, options: BytesLike, payInLzToken: boolean}

    export type MessagingParamsStructOutput = [dstEid: bigint, receiver: string, message: string, options: string, payInLzToken: boolean] & {dstEid: bigint, receiver: string, message: string, options: string, payInLzToken: boolean }
  

    export type MessagingFeeStruct = {nativeFee: BigNumberish, lzTokenFee: BigNumberish}

    export type MessagingFeeStructOutput = [nativeFee: bigint, lzTokenFee: bigint] & {nativeFee: bigint, lzTokenFee: bigint }
  

    export type MessagingReceiptStruct = {guid: BytesLike, nonce: BigNumberish, fee: MessagingFeeStruct}

    export type MessagingReceiptStructOutput = [guid: string, nonce: bigint, fee: MessagingFeeStructOutput] & {guid: string, nonce: bigint, fee: MessagingFeeStructOutput }
  

    export type SetConfigParamStruct = {eid: BigNumberish, configType: BigNumberish, config: BytesLike}

    export type SetConfigParamStructOutput = [eid: bigint, configType: bigint, config: string] & {eid: bigint, configType: bigint, config: string }
  

  export interface EndpointV2MockInterface extends Interface {
    getFunction(nameOrSignature: "burn" | "clear" | "composeQueue" | "defaultReceiveLibrary" | "defaultReceiveLibraryTimeout" | "defaultSendLibrary" | "deliverAllPackets" | "deliverPacketFrom" | "destLzEndpoint" | "eid" | "getConfig" | "getReceiveLibrary" | "getRegisteredLibraries" | "getSendContext" | "getSendLibrary" | "inboundNonce" | "inboundPayloadHash" | "initializable" | "isDefaultSendLibrary" | "isRegisteredLibrary" | "isSendingMessage" | "isSupportedEid" | "isValidReceiveLibrary" | "lazyInboundNonce" | "lzCompose" | "lzReceive" | "lzToken" | "nativeToken" | "nextGuid" | "nilify" | "outboundNonce" | "packetCount" | "packets" | "quote" | "receiveLibraryTimeout" | "registerLibrary" | "send" | "sendCompose" | "setConfig" | "setDefaultReceiveLibrary" | "setDefaultReceiveLibraryTimeout" | "setDefaultSendLibrary" | "setDelegate" | "setDestLzEndpoint" | "setLzToken" | "setReceiveLibrary" | "setReceiveLibraryTimeout" | "setSendLibrary" | "skip" | "verifiable" | "verify"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "ComposeDelivered" | "ComposeSent" | "DefaultReceiveLibrarySet" | "DefaultReceiveLibraryTimeoutSet" | "DefaultSendLibrarySet" | "DelegateSet" | "InboundNonceSkipped" | "LibraryRegistered" | "LzComposeAlert" | "LzReceiveAlert" | "LzTokenSet" | "PacketBurnt" | "PacketDelivered" | "PacketNilified" | "PacketSent" | "PacketVerified" | "ReceiveLibrarySet" | "ReceiveLibraryTimeoutSet" | "SendLibrarySet"): EventFragment;

    encodeFunctionData(functionFragment: 'burn', values: [AddressLike, BigNumberish, BytesLike, BigNumberish, BytesLike]): string;
encodeFunctionData(functionFragment: 'clear', values: [AddressLike, OriginStruct, BytesLike, BytesLike]): string;
...
encodeFunctionData(functionFragment: 'deliverAllPackets', values?: undefined): string;
encodeFunctionData(functionFragment: 'deliverPacketFrom', values: [OriginStruct, AddressLike, BytesLike, BytesLike]): string;
encodeFunctionData(functionFragment: 'destLzEndpoint', values: [AddressLike]): string;
...
encodeFunctionData(functionFragment: 'initializable', values: [OriginStruct, AddressLike]): string;
...
encodeFunctionData(functionFragment: 'lzCompose', values: [AddressLike, AddressLike, BytesLike, BigNumberish, BytesLike, BytesLike]): string;
...
encodeFunctionData(functionFragment: 'nilify', values: [AddressLike, BigNumberish, BytesLike, BigNumberish, BytesLike]): string;
encodeFunctionData(functionFragment: 'outboundNonce', values: [AddressLike, BigNumberish, BytesLike]): string;
encodeFunctionData(functionFragment: 'packetCount', values?: undefined): string;
encodeFunctionData(functionFragment: 'packets', values: [BigNumberish]): string;
...
encodeFunctionData(functionFragment: 'setConfig', values: [AddressLike, AddressLike, SetConfigParamStruct[]]): string;
...
encodeFunctionData(functionFragment: 'setReceiveLibrary', values: [AddressLike, BigNumberish, AddressLike, BigNumberish]): string;
encodeFunctionData(functionFragment: 'setReceiveLibraryTimeout', values: [AddressLike, BigNumberish, AddressLike, BigNumberish]): string;
encodeFunctionData(functionFragment: 'setSendLibrary', values: [AddressLike, BigNumberish, AddressLike]): string;
encodeFunctionData(functionFragment: 'skip', values: [AddressLike, BigNumberish, BytesLike, BigNumberish]): string;
...
decodeFunctionResult(functionFragment: 'deliverAllPackets', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'deliverPacketFrom', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'destLzEndpoint', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'packetCount', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'verify', data: BytesLike): Result;
    ...
    export namespace ComposeDeliveredEvent {
      export type InputTuple = [from: AddressLike, to: AddressLike, guid: BytesLike, index: BigNumberish];
      export type OutputTuple = [from: string, to: string, guid: string, index: bigint];
      export interface OutputObject {from: string, to: string, guid: string, index: bigint };
    ...
    export namespace ComposeSentEvent {
      export type InputTuple = [from: AddressLike, to: AddressLike, guid: BytesLike, index: BigNumberish, message: BytesLike];
      export type OutputTuple = [from: string, to: string, guid: string, index: bigint, message: string];
      export interface OutputObject {from: string, to: string, guid: string, index: bigint, message: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace DefaultReceiveLibrarySetEvent {
      ...
      export interface OutputObject {eid: bigint, newLib: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace DefaultReceiveLibraryTimeoutSetEvent {
      export type InputTuple = [eid: BigNumberish, oldLib: AddressLike, expiry: BigNumberish];
      export type OutputTuple = [eid: bigint, oldLib: string, expiry: bigint];
      export interface OutputObject {eid: bigint, oldLib: string, expiry: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace DelegateSetEvent {
      ...
      export interface OutputObject {sender: string, delegate: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace InboundNonceSkippedEvent {
      export type InputTuple = [srcEid: BigNumberish, sender: BytesLike, receiver: AddressLike, nonce: BigNumberish];
      export type OutputTuple = [srcEid: bigint, sender: string, receiver: string, nonce: bigint];
      export interface OutputObject {srcEid: bigint, sender: string, receiver: string, nonce: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace LibraryRegisteredEvent {
      ...
      export interface OutputObject {newLib: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace LzComposeAlertEvent {
      export type InputTuple = [from: AddressLike, to: AddressLike, executor: AddressLike, guid: BytesLike, index: BigNumberish, gas: BigNumberish, value: BigNumberish, message: BytesLike, extraData: BytesLike, reason: BytesLike];
      export type OutputTuple = [from: string, to: string, executor: string, guid: string, index: bigint, gas: bigint, value: bigint, message: string, extraData: string, reason: string];
      export interface OutputObject {from: string, to: string, executor: string, guid: string, index: bigint, gas: bigint, value: bigint, message: string, extraData: string, reason: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace LzReceiveAlertEvent {
      export type InputTuple = [receiver: AddressLike, executor: AddressLike, origin: OriginStruct, guid: BytesLike, gas: BigNumberish, value: BigNumberish, message: BytesLike, extraData: BytesLike, reason: BytesLike];
      export type OutputTuple = [receiver: string, executor: string, origin: OriginStructOutput, guid: string, gas: bigint, value: bigint, message: string, extraData: string, reason: string];
      export interface OutputObject {receiver: string, executor: string, origin: OriginStructOutput, guid: string, gas: bigint, value: bigint, message: string, extraData: string, reason: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace PacketBurntEvent {
      export type InputTuple = [srcEid: BigNumberish, sender: BytesLike, receiver: AddressLike, nonce: BigNumberish, payloadHash: BytesLike];
      export type OutputTuple = [srcEid: bigint, sender: string, receiver: string, nonce: bigint, payloadHash: string];
      export interface OutputObject {srcEid: bigint, sender: string, receiver: string, nonce: bigint, payloadHash: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace PacketDeliveredEvent {
      ...
      export interface OutputObject {origin: OriginStructOutput, receiver: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace PacketSentEvent {
      export type InputTuple = [encodedPayload: BytesLike, options: BytesLike, sendLibrary: AddressLike];
      export type OutputTuple = [encodedPayload: string, options: string, sendLibrary: string];
      export interface OutputObject {encodedPayload: string, options: string, sendLibrary: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace PacketVerifiedEvent {
      export type InputTuple = [origin: OriginStruct, receiver: AddressLike, payloadHash: BytesLike];
      export type OutputTuple = [origin: OriginStructOutput, receiver: string, payloadHash: string];
      export interface OutputObject {origin: OriginStructOutput, receiver: string, payloadHash: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace ReceiveLibrarySetEvent {
      export type InputTuple = [receiver: AddressLike, eid: BigNumberish, newLib: AddressLike];
      export type OutputTuple = [receiver: string, eid: bigint, newLib: string];
      export interface OutputObject {receiver: string, eid: bigint, newLib: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace ReceiveLibraryTimeoutSetEvent {
      export type InputTuple = [receiver: AddressLike, eid: BigNumberish, oldLib: AddressLike, timeout: BigNumberish];
      export type OutputTuple = [receiver: string, eid: bigint, oldLib: string, timeout: bigint];
      export interface OutputObject {receiver: string, eid: bigint, oldLib: string, timeout: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace SendLibrarySetEvent {
      export type InputTuple = [sender: AddressLike, eid: BigNumberish, newLib: AddressLike];
      export type OutputTuple = [sender: string, eid: bigint, newLib: string];
      export interface OutputObject {sender: string, eid: bigint, newLib: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    clear: TypedContractMethod<
      [arg0: AddressLike, arg1: OriginStruct, arg2: BytesLike, arg3: BytesLike, ],
      [void],
      'nonpayable'
    >
    ...
    deliverAllPackets: TypedContractMethod<
      [],
      [void],
      'nonpayable'
    >
    ...
    deliverPacketFrom: TypedContractMethod<
      [_origin: OriginStruct, _receiver: AddressLike, _guid: BytesLike, _message: BytesLike, ],
      [void],
      'nonpayable'
    >
    ...
    destLzEndpoint: TypedContractMethod<
      [arg0: AddressLike, ],
      [string],
      'view'
    >
    ...
    getRegisteredLibraries: TypedContractMethod<
      [],
      [string[]],
      'view'
    >
    ...
    inboundPayloadHash: TypedContractMethod<
      [arg0: AddressLike, arg1: BigNumberish, arg2: BytesLike, arg3: BigNumberish, ],
      [string],
      'view'
    >
    ...
    isSendingMessage: TypedContractMethod<
      [],
      [boolean],
      'view'
    >
    ...
    isSupportedEid: TypedContractMethod<
      [arg0: BigNumberish, ],
      [boolean],
      'view'
    >
    ...
    lzCompose: TypedContractMethod<
      [arg0: AddressLike, arg1: AddressLike, arg2: BytesLike, arg3: BigNumberish, arg4: BytesLike, arg5: BytesLike, ],
      [void],
      'payable'
    >
    ...
    lzReceive: TypedContractMethod<
      [_origin: OriginStruct, _receiver: AddressLike, _guid: BytesLike, _message: BytesLike, _extraData: BytesLike, ],
      [void],
      'payable'
    >
    ...
    packetCount: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    packets: TypedContractMethod<
      [arg0: BigNumberish, ],
      [[bigint, string, string, string, string, string, bigint] & {dstEid: bigint, receiver: string, message: string, options: string, sender: string, guid: string, nonce: bigint }],
      'view'
    >
    ...
    quote: TypedContractMethod<
      [arg0: MessagingParamsStruct, arg1: AddressLike, ],
    ...
    send: TypedContractMethod<
      [_params: MessagingParamsStruct, arg1: AddressLike, ],
    ...
    setDestLzEndpoint: TypedContractMethod<
      [_destOApp: AddressLike, _destEndpoint: AddressLike, ],
      [void],
      'nonpayable'
    >
...
getFunction(nameOrSignature: 'composeQueue'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'defaultReceiveLibrary'): TypedContractMethod<
      [arg0: BigNumberish, ],
      [string],
      'view'
    >;
getFunction(nameOrSignature: 'defaultReceiveLibraryTimeout'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'defaultSendLibrary'): TypedContractMethod<
      [arg0: BigNumberish, ],
      [string],
      'view'
    >;
getFunction(nameOrSignature: 'deliverAllPackets'): TypedContractMethod<
      [],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'deliverPacketFrom'): TypedContractMethod<
      [_origin: OriginStruct, _receiver: AddressLike, _guid: BytesLike, _message: BytesLike, ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'destLzEndpoint'): TypedContractMethod<
      [arg0: AddressLike, ],
      [string],
      'view'
    >;
getFunction(nameOrSignature: 'eid'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
...
getFunction(nameOrSignature: 'getReceiveLibrary'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getRegisteredLibraries'): TypedContractMethod<
      [],
      [string[]],
      'view'
    >;
getFunction(nameOrSignature: 'getSendContext'): TypedContractMethod<
      [],
      [[bigint, string]],
      'view'
    >;
...
getFunction(nameOrSignature: 'inboundPayloadHash'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'initializable'): TypedContractMethod<
      [arg0: OriginStruct, arg1: AddressLike, ],
      [boolean],
      'view'
    >;
getFunction(nameOrSignature: 'isDefaultSendLibrary'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'isRegisteredLibrary'): TypedContractMethod<
      [arg0: AddressLike, ],
      [boolean],
      'view'
    >;
getFunction(nameOrSignature: 'isSendingMessage'): TypedContractMethod<
      [],
      [boolean],
      'view'
    >;
getFunction(nameOrSignature: 'isSupportedEid'): TypedContractMethod<
      [arg0: BigNumberish, ],
      [boolean],
      'view'
    >;
...
getFunction(nameOrSignature: 'lzReceive'): TypedContractMethod<
      ...
      'payable'
    >;
getFunction(nameOrSignature: 'lzToken'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
...
getFunction(nameOrSignature: 'nextGuid'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'nilify'): TypedContractMethod<
      [arg0: AddressLike, arg1: BigNumberish, arg2: BytesLike, arg3: BigNumberish, arg4: BytesLike, ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'outboundNonce'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'packetCount'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'packets'): TypedContractMethod<
      [arg0: BigNumberish, ],
      [[bigint, string, string, string, string, string, bigint] & {dstEid: bigint, receiver: string, message: string, options: string, sender: string, guid: string, nonce: bigint }],
      'view'
    >;
...
getFunction(nameOrSignature: 'receiveLibraryTimeout'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'registerLibrary'): TypedContractMethod<
      [arg0: AddressLike, ],
      [void],
      'nonpayable'
    >;
...
getFunction(nameOrSignature: 'setDestLzEndpoint'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'setLzToken'): TypedContractMethod<
      [arg0: AddressLike, ],
      [void],
      'nonpayable'
    >;
...
getEvent(key: 'DelegateSet'): TypedContractEvent<DelegateSetEvent.InputTuple, DelegateSetEvent.OutputTuple, DelegateSetEvent.OutputObject>;
...
getEvent(key: 'PacketBurnt'): TypedContractEvent<PacketBurntEvent.InputTuple, PacketBurntEvent.OutputTuple, PacketBurntEvent.OutputObject>;
...
getEvent(key: 'PacketNilified'): TypedContractEvent<PacketNilifiedEvent.InputTuple, PacketNilifiedEvent.OutputTuple, PacketNilifiedEvent.OutputObject>;
...
getEvent(key: 'ReceiveLibraryTimeoutSet'): TypedContractEvent<ReceiveLibraryTimeoutSetEvent.InputTuple, ReceiveLibraryTimeoutSetEvent.OutputTuple, ReceiveLibraryTimeoutSetEvent.OutputObject>;
getEvent(key: 'SendLibrarySet'): TypedContractEvent<SendLibrarySetEvent.InputTuple, SendLibrarySetEvent.OutputTuple, SendLibrarySetEvent.OutputObject>;
    ...
    filters: {
      ...
      'DefaultReceiveLibrarySet(uint32,address)': TypedContractEvent<DefaultReceiveLibrarySetEvent.InputTuple, DefaultReceiveLibrarySetEvent.OutputTuple, DefaultReceiveLibrarySetEvent.OutputObject>;
      ...
      'DelegateSet(address,address)': TypedContractEvent<DelegateSetEvent.InputTuple, DelegateSetEvent.OutputTuple, DelegateSetEvent.OutputObject>;
      DelegateSet: TypedContractEvent<DelegateSetEvent.InputTuple, DelegateSetEvent.OutputTuple, DelegateSetEvent.OutputObject>;
      ...
      'PacketBurnt(uint32,bytes32,address,uint64,bytes32)': TypedContractEvent<PacketBurntEvent.InputTuple, PacketBurntEvent.OutputTuple, PacketBurntEvent.OutputObject>;
      PacketBurnt: TypedContractEvent<PacketBurntEvent.InputTuple, PacketBurntEvent.OutputTuple, PacketBurntEvent.OutputObject>;
      ...
      'PacketNilified(uint32,bytes32,address,uint64,bytes32)': TypedContractEvent<PacketNilifiedEvent.InputTuple, PacketNilifiedEvent.OutputTuple, PacketNilifiedEvent.OutputObject>;
      PacketNilified: TypedContractEvent<PacketNilifiedEvent.InputTuple, PacketNilifiedEvent.OutputTuple, PacketNilifiedEvent.OutputObject>;
      ...
      'ReceiveLibrarySet(address,uint32,address)': TypedContractEvent<ReceiveLibrarySetEvent.InputTuple, ReceiveLibrarySetEvent.OutputTuple, ReceiveLibrarySetEvent.OutputObject>;
      ...
      'ReceiveLibraryTimeoutSet(address,uint32,address,uint256)': TypedContractEvent<ReceiveLibraryTimeoutSetEvent.InputTuple, ReceiveLibraryTimeoutSetEvent.OutputTuple, ReceiveLibraryTimeoutSetEvent.OutputObject>;
      ReceiveLibraryTimeoutSet: TypedContractEvent<ReceiveLibraryTimeoutSetEvent.InputTuple, ReceiveLibraryTimeoutSetEvent.OutputTuple, ReceiveLibraryTimeoutSetEvent.OutputObject>;
